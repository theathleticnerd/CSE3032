...
class LinkedList {
    ...
    void rotate(int k){
        ...
        //current will either point dto kth or NULL after
        ...
        //count of nodes in the linked list. Don't change 
        //this list in this ca
        if (current==null)
            return;
     ...
     * of a linked list and an int, push a new node on the 
    ...
    public static void main(String[] args){
        ...
        System.out.println("Rotate Liked List");
        llist.printList();
    }
}
